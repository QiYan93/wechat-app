Page({
    ...
    /* 去详情页 */
    toDetail(){
        var type = this.data.expressCode[this.data.index].type;
        var number = this.data.number;
        var name = this.data.expressCode[this.data.index].name;
        var that = this;
        this.setData({
            disabled: true
        })
                ...
                wx.request({
                    ...
                    success: function (res) {
                        ...
                        if(res.data.data.Shippers.length>1){
                            ...
                            var ShipperName = res.data.data.Shippers[0].ShipperName;
                            wx.navigateTo({
                                url: '/page/detail/detail?type='+ShipperCode+'&number='+number+'&name='+ShipperName
                            })
                        }
                    },
                    fail: function () {
